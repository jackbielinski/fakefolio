        ...
        <form id="edit-profile-form" method="POST" enctype="multipart/form-data">
            <table class="table-auto w-full">
                <tr>
                    ...
                    <td>
                        <?php
                            ...
                            echo '<input type="text" id="username" name="username" value="' . $username_value . '" ' . ($is_username_change_disabled ? 'disabled' : '') . ' required>';
                ...
                <tr>
                    ...
                    <td><input type="email" id="email" name="email" value="<?php echo htmlspecialchars($active_user['email']); ?>" required></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <img class="inline-block" id="profile_picture_prev" src="../_static/<?php echo !empty($active_user['profile_picture_path']) ? htmlspecialchars($active_user['profile_picture_path']) : 'default_profile.png'; ?>" alt="Profile Picture" width="75">
